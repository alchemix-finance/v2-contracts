...
import type {
  IAlchemistV2State,
  IAlchemistV2StateInterface,
} from "../IAlchemistV2State";
...
export class IAlchemistV2State__factory {
  static readonly abi = _abi;
  static createInterface(): IAlchemistV2StateInterface {
    return new utils.Interface(_abi) as IAlchemistV2StateInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAlchemistV2State {
    return new Contract(address, _abi, signerOrProvider) as IAlchemistV2State;
  }
}
