...
import type {
  IAlchemistV2Events,
  IAlchemistV2EventsInterface,
} from "../IAlchemistV2Events";
...
export class IAlchemistV2Events__factory {
  static readonly abi = _abi;
  static createInterface(): IAlchemistV2EventsInterface {
    return new utils.Interface(_abi) as IAlchemistV2EventsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAlchemistV2Events {
    return new Contract(address, _abi, signerOrProvider) as IAlchemistV2Events;
  }
}
