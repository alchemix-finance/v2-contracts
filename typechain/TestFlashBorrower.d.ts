...
interface TestFlashBorrowerInterface extends ethers.utils.Interface {
  functions: {
    "CALLBACK_SUCCESS()": FunctionFragment;
    "onFlashLoan(address,address,uint256,uint256,bytes)": FunctionFragment;
    "takeLoan(address,address,uint256)": FunctionFragment;
  };
...
export class TestFlashBorrower extends BaseContract {
  ...
  interface: TestFlashBorrowerInterface;
