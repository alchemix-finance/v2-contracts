...
interface OZUpgradeTestInitialInterface extends ethers.utils.Interface {
  functions: {
...
export class OZUpgradeTestInitial extends BaseContract {
  ...
  interface: OZUpgradeTestInitialInterface;
