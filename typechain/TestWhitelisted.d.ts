...
interface TestWhitelistedInterface extends ethers.utils.Interface {
  functions: {
...
export type SuccessEvent = TypedEvent<[] & {}>;

export class TestWhitelisted extends BaseContract {
  ...
  interface: TestWhitelistedInterface;
