...
interface ContractWhitelisterInterface extends ethers.utils.Interface {
  functions: {
...
export class ContractWhitelister extends BaseContract {
  ...
  interface: ContractWhitelisterInterface;
