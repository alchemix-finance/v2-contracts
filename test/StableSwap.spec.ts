...
describe("StableSwap", () => {
  ...
  beforeEach(async () => {
    const bridgeTokenFactory = await ethers.getContractFactory("ERC20Mock");
    ...
    alchemicToken = (await crossChainCanonicalAlchemicTokenV2Factory
      .connect(admin)
      .deploy()) as CrossChainCanonicalAlchemicTokenV2;
    await alchemicToken.initialize("alchemix USD", "alUSD", [
      bridgeToken.address,
    ]);
  });
